  ...
  return (
    ...
    >
      <form onSubmit={formik.handleSubmit} className="flex flex-col gap-3 sm:gap-4">
        ...
        <Link 
          href="/login" 
          className="text-xs sm:text-sm font-medium text-gray-600 hover:text-gray-900 transition-colors block text-center mt-2"
        >
          Back to Login
        </Link>
        ...
        {isSuccess && (
          <div className="mt-3 sm:mt-4 p-2 sm:p-3 bg-green-50 border border-green-200 rounded-lg text-xs sm:text-sm text-green-600 flex items-start gap-2">
            <div>
